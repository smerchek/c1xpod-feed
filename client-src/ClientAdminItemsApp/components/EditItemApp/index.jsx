                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <AdminInput
                      labelComponent={
                        <ExplainText
                          bundle={
                            CONTROLS_TEXTS_DICT[ITEM_CONTROLS.SPOTIFY_URL]
                          }
                        />
                      }
                      value={item["spotify:url"]}
                      onChange={(e) =>
                        this.onUpdateItemMeta({ "spotify:url": e.target.value })
                      }
                    />
                    <AdminInput
                      labelComponent={
                        <ExplainText
                          bundle={
                            CONTROLS_TEXTS_DICT[ITEM_CONTROLS.YOUTUBE_URL]
                          }
                        />
                      }
                      value={item["youtube:url"]}
                      onChange={(e) =>
                        this.onUpdateItemMeta({ "youtube:url": e.target.value })
                      }
                    />
                  </div>
                </div>
