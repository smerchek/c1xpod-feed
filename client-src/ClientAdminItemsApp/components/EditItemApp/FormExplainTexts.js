...
export const CONTROLS_TEXTS_DICT = {
  ...
  [ITEM_CONTROLS.SPOTIFY_URL]: {
    linkName: "Spotify url",
    modalTitle: "Item / Spotify url",
    text: "A Spotify url for this item.",
    rss: "<channel><item><spotify:url>https://open.spotify.com/episode/1234567890</spotify:url></item></channel>",
    json: '{ "items": [{"spotify:url": "https://open.spotify.com/episode/1234567890"}] }',
  },
  [ITEM_CONTROLS.YOUTUBE_URL]: {
    linkName: "Youtube url",
    modalTitle: "Item / Youtube url",
    text: "A Youtube url for this item.",
    rss: "<channel><item><youtube:url>https://www.youtube.com/watch?v=1234567890</youtube:url></item></channel>",
    json: '{ "items": [{"youtube:url": "https://www.youtube.com/watch?v=1234567890"}] }',
  },
};
